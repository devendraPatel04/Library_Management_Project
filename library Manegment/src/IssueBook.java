...
public class IssueBook extends JFrame implements ActionListener{
	...
	l15.setBounds(20, 340, 118, 26);
        ...
        t15.setFont(new Font("Trebuchet MS",Font.BOLD,15));
        //t15.setBorder(new LineBorder(new Color(204, 199, 255),1,true));
        t15.setBackground(Color.BLACK);
        t15.setForeground(Color.WHITE);
        t15.setText("   "+date1);
        t15.setBounds(137,343,121,22);
        add(t15);
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            if(ae.getSource()==b3){
                if(t1.getText().equals("") || t8.getText().equals("")){
                    JOptionPane.showMessageDialog(null,"fill Book id ANd Studnet id");
                }
                else{
                    try{
