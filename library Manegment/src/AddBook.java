...
public class AddBook extends JFrame implements ActionListener{
    ...
    public AddBook(){
        super("Add Book JFrame");
        setBounds(450,100,490,442);
        setLayout(null);
	...
	add(t6);
        ...
        panel.setBorder(new TitledBorder(new LineBorder(new Color(138,43,226),2,true),"Add Books",TitledBorder.LEADING,TitledBorder.TOP,null,new Color(0,0,255)));
        panel.setBounds(30,20,390,340);
